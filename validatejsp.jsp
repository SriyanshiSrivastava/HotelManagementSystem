...
<body>
        ...
        <% Connection con=new connect().con;
           String rooomType = request.getParameter("rooom-type");
           
           // Query to retrieve available rooms based on room type and status
           PreparedStatement ps = con.prepareStatement("SELECT * FROM roomhms WHERE rooomtype=? AND roomstatus='unoccupied'");
           ps.setString(1, rooomType);
